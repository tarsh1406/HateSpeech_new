...
def train_and_evaluate():
    ...
    results_df.to_csv('models/naive_bayes_accuracy_results.csv', index=False)
    ...
    plt.ylabel('Score')
    plt.title('Naive Bayes Evaluation Metrics vs Training Size')
    plt.legend()
    plt.savefig('models/naive_bayes_evaluation_metrics_graph.png')  # Save the graph
    plt.show()
