...
def train_and_evaluate():
    ...
    results_df.to_csv('models/random_forest_accuracy_results.csv', index=False)
    ...
    plt.ylabel('Score')
    plt.title('Random Forest Evaluation Metrics vs Training Size')
    plt.legend()
    plt.savefig('models/random_forest_evaluation_metrics_graph.png')  # Save the graph
    plt.show()
