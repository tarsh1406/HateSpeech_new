...
def train_and_evaluate():
    ...
    results_df.to_csv('models/svm_accuracy_results.csv', index=False)
    ...
    plt.ylabel('Score')
    plt.title('SVM Evaluation Metrics vs Training Size')
    plt.legend()
    plt.savefig('models/svm_evaluation_metrics_graph.png')  # Save the graph
    plt.show()
